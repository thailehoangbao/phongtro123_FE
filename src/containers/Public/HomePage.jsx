...
const HomePage = () => {
    ...
    return (
        <div className='w-full flex flex-col gap-3'>
            <div className=''>
                <h1 className='font-bold text-lg'>Kênh thông tin phòng trọ số 1 Việt Nam</h1>
                <p>Kênh thông tin phòng trọ số 1 Việt Nam - Website đăng tin cho thuê phòng trọ, nhà nguyên căn, căn hộ ỡ ghép nhanh hiệu quả với 100.000 tin đăng và 2.500.000 lượt xem mỗi tháng.</p>
            </div>
            <Province />
