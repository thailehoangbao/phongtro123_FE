    ...
    return (
        <div className='flex items-center'>
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex items-center'><span>Mã tài khoản: </span><span className='w-20 font-semibold inline-block whitespace-nowrap overflow-hidden text-ellipsis'>{currentData?.id}</span></div>
            </div>
        </div>
    )
}
